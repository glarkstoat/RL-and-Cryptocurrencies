...
class PAMR(TDAgent):
    ...
    """
    def __init__(self, lookback_window_size=1, eps=0.5, C=500, variant=2, b=None):
        """
        ...
        """
        super(PAMR, self).__init__(lookback_window_size)
    ...
    def decide_weights(self, x, prev_weights):
        ...
        prev_weights = self.b
        b = self.update(prev_weights, x, self.eps, self.C)
        b = b.ravel()
        self.b = b
        return self.b
