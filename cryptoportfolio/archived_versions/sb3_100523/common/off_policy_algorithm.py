...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            ############ !! MODIFICATION !! ############
            # passing replay_buffer.pos to the agent and
            # telling it to overwrite the weight_storage 
            # at pos+1 with the actions
            env.envs[0].env.overwrite_weight_storage(replay_buffer.pos)
            ############ !! MODIFICATION !! ############
