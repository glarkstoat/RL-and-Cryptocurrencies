...
class ActorCriticPolicy(BasePolicy):
    ...
    def __init__(
        ...
        #####################
        self.runtime_feature_extractor = 0
        self.runtime_mlp_extractor = 0
        self.runtime_values_actions = 0        
        #####################
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        self.runtime_feature_extractor += runtime
        ###########
        ...
        runtime = (datetime.datetime.now() - start).total_seconds()
        self.runtime_mlp_extractor += runtime
        ###########
        ...
        runtime = (datetime.datetime.now() - start).total_seconds()
        self.runtime_values_actions += runtime
        ############
