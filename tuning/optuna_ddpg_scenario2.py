...
def sample_ddpg_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    net_arch = trial.suggest_categorical("net_arch", ["default", "tiny", "tiny+", "small", "medium", "large"])
    net_arch = {"default":[400,300], "tiny":[10,10], "tiny+":[10,10,10], "small":[100,100], "medium":[300,300], "large":[128,256]}[net_arch]
...
study_name = "scenario2-ddpg-cnn_nosoft-cheating"  
