...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    learning_rate = trial.suggest_float("learning_rate", 0.000000001, 0.00001, log=False)
...
def objective(trial: optuna.Trial) -> float:
    ...
    data = open("scenario2-ppo-nosoft_mlp_cnn-cheating-new-lr-small-batches.csv", "a")
    data.write("\n")
...
study_name = "scenario2-ppo-nosoft_cnn_mlp-cheating-new-lr-small"
