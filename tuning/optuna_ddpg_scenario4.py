...
def sample_ddpg_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    net_arch = trial.suggest_categorical("net_arch", ["tiny","tiny+","small", "small+", "small++", "small+++", "medium"])
    net_arch = {"tiny":[10,10], "tiny+":[16,16], "small":[100,100], "small+++":[126,256], "small++":[256,126], "small+":[400,300], "medium":[300,300]}[net_arch]
...
study_name = "scenario4-ddpg-nosoft-cnn-cheating"  
