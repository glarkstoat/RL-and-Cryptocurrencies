...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    learning_rate = trial.suggest_float("learning_rate", 1e-6, 0.02, log=False)
...
def objective(trial: optuna.Trial) -> float:
    ...
    data = open("scenario1-ppo-nosoft_mlp_cnn-cheating-new-batches.csv", "a")
    data.write("\n")
...
study_name = "scenario1-ppo-nosoft_cnn_mlp-cheating"
