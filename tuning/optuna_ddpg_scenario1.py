...
def sample_ddpg_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    net_arch = trial.suggest_categorical("net_arch", ["default", "tiny", "tiny+", "small", "medium", "large", "small+", "small++", "small+++"])
    net_arch = {"default":[400,300], "tiny":[10,10], "small+":[128,128], "small++":[256,128], "small+++":[128,256], "tiny+":[10,10,10], "small":[100,100], "medium":[300,300], "large":[500,500]}[net_arch]
...
study_name = "scenario1-ddpg-cnn_nosoft-cheating-new-lr"  
